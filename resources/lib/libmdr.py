...
class libmdr(lm4):
	...
	def libMdrListMain(self):
		l = []
		l.append({'metadata':{'name':'Live'}, 'params':{'mode':'libMdrListPlus', 'url':'https://www.mdr.de/video/livestreams/livestreams-socialtv-event-100-meta.xml'}, 'type':'dir'})
		l.append({'metadata':{'name':'Videos'}, 'params':{'mode':'libMdrListPlus', 'url':'https://www.mdr.de/video/mdrplus-videos100-meta.xml'}, 'type':'dir'})
